...
export function Navbar() {
  return (
    <aside>
      <nav
        className="min-h-[64px] md:my-container lg:p-0 mx-auto flex flex-row items-center px-[24px] rounded-lg  bg-white dark:bg-black justify-between tracking-tight "
        id="nav"
      >
        <div>
          <Link href="/">
